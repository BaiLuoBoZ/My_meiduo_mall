...
SECRET_KEY = 'nf!kput5)t0-$r7zoq@nm6j1pth@9isa-oyn^a9*dn_fl%*l1u'
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = 'zhuzancong@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'zxc9527'
# 收件人看到的发件人
EMAIL_FROM = '美多商城<zhuzancong@163.com>'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.195.128:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
        'INDEX_NAME': 'zzc_meiduo',  # 指定elasticsearch建立的索引库的名称
    },
}
